...
import OilsGrid from "@/containers/_user/OilsGrid";
          ...
          return (
            <>
              {isLoading ? (
                ...
                <>
                  <Table>
                    <TableCaption>Oils</TableCaption>
                    <TableHeader>
                      <TableRow>
                        <TableHead>Id</TableHead>
                        <TableHead>Name</TableHead>
                        <TableHead>Amount In Barel</TableHead>
                    ...
                    <TableBody>
                      {data.pages.map((row, index) => {
                        return <OilsGrid key={index} page={index} row={row} />;
                      })}
                    </TableBody>
                  </Table>
